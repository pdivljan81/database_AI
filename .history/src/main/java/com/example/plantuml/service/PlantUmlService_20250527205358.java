...
public class PlantUmlService {
    ...
    private static final String MISTRAL_API_KEY = "Uxg63tTXlpS9eVYlwsSXIGJnFjPeRZTN";

    private static final String GEMINI_API_URL = "https://generativelanguage.googleapis.com/v1/models/gemini-1.5-flash:generateContent?key=AIzaSyCY64JlmXVcMNaTlyWxb2n3SKlpZkCD-Ww";
    ...
    public String generateUmlFromText(String inputText) throws IOException {
        ...
        connection.setRequestProperty("Authorization", "Bearer " + MISTRAL_API_KEY);
    ...
    public String generateUmlWithGemini(String inputText) throws IOException {
        ...
        HttpURLConnection connection = (HttpURLConnection) new URL(GEMINI_API_URL).openConnection();
        connection.setRequestMethod("POST");
        connection.setDoOutput(true);
        connection.setRequestProperty("Content-Type", "application/json");
