...
public class PlantUmlService {
    ...
    private static final String API_URL_GEMINI = "https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=YOUR_GEMINI_KEY";
    ...
    private static final String GEMINI_KEY = "YOUR_GEMINI_KEY";
    private static final String GPT_KEY = "YOUR_GPT_KEY";
    ...
    public String generateUmlFromText(String inputText, ModelType modelType) throws IOException {
        switch (modelType) {
            case MISTRAL:
                return callMistral(inputText);
            case GEMINI:
                return callGemini(inputText);
            case GPT:
                return callGpt(inputText);
            default:
                throw new IllegalArgumentException("Nepoznat model tip.");
        }
    }
