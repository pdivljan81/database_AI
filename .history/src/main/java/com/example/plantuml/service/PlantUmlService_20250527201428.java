...
public class PlantUmlService {
    ...
    private static final String API_URL_GEMINI = "https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=GEMINI_KEY";
    ...
    private String callGemini(String inputText) throws IOException {
        ...
        return callApi(API_URL_GEMINI.replace("GEMINI_KEY", GEMINI_KEY), requestBody.toString(), null, null);
    }
